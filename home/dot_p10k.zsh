# Generated by Powerlevel10k configuration wizard on 2021-09-07 at 14:49 PDT.
...
() {
  ...
  # respectively.
  typeset -g POWERLEVEL9K_DIR_TRUNCATE_BEFORE_MARKER=first:0
...
#   typeset -g POWERLEVEL9K_DIR_QMK_VISUAL_IDENTIFIER_EXPANSION='Ψ'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=10
